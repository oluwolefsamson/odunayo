      ...
      <div className="md:flex md:justify-between md:gap-16 mt-20 px-4">
        ...
        >
          ...
          <p className="mt-10 mb-7 text-1xl">
            Hello, I'm Eleta Odunayo, a passionate Fullstack web developer with
            a keen eye for detail and a drive for innovation. With a solid
            foundation in both front-end and back-end development, I thrive on
            bringing ideas to life through elegant and efficient code. My
            journey in web development is fueled by a relentless pursuit of
            excellence and a commitment to staying at the forefront of
            technological advancements. Whether it's crafting intuitive user
